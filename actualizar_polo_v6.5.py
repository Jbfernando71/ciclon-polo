...
# Ruta específica de Polo proporcionada por el usuario.
# Evita tomar accidentalmente el primer ciclón publicado en el WebAviso general.
WEBAVISO_POLO = "https://smn.conagua.gob.mx/tools/GUI/PortalLaravel/public/WebAviso?searchText=10838"
...
def main():
    print("=" * 72)
    print(" ACTUALIZADOR CICLÓN POLO V6.5")
    print(" FUENTE PRIMARIA:", PORTAL)
    print(" WEBAVISO ESPECÍFICO POLO:", WEBAVISO_POLO)
    print(" PDF HISTÓRICO: NO UTILIZADO")
    print("=" * 72)

    # V6.5: ya no descubre/usa el iframe general.
    # Se consulta exclusivamente la ruta específica de Polo.
    web = WEBAVISO_POLO
    ...
    print()
    print("ACTUALIZACIÓN CORRECTA DESDE WEBAVISO ESPECÍFICO DE POLO")
    print("Aviso:", aviso)
